...
<head>
    ...
    <link href="{{asset('frontend/https://fonts.googleapis.com/css2?family=Roboto:wght@300;400;500;700;900&display=swap')}}" rel="stylesheet">   

    <!-- Font Awesome -->
    <link href="{{asset('frontend/https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.0/css/all.min.css" rel="stylesheet')}}">
    ...
    <div class="container-fluid">
        ...
        <div class="row align-items-center py-2 px-lg-5">
            ...
            <div class="col-lg-8 text-center text-lg-right">
                <img class="img-fluid" src="{{('frontend/img/ads-700x70.jpg')}}" alt="">
            </div>
        </div>
    </div>
    <!-- Topbar End -->
